...
Item:  <a href="go_to_cart_page.php" style="text-decoration:none;color:#663300; "> <?php total_items(); ?></a>
</div>
<div id="price_right_content_page">
price: <a href="go_to_cart_page.php" style="text-decoration:none; color:#663300;">Rs.<?php total_price() ;?></a><br>
...
<?php
getProduct() ;          //call  function to display  products
