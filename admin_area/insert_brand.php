...
<form 	action="insert_brand.php" method="post" name="insert_brand" >

<h2 style="margin-top:160px;"><b>Add New Brand:</b></h2>
<input type="text" name="product_brand" size="30"/>

 <h2><input type="submit" name="brand_name" value="Submit"/></h2>
...
if(isset($_POST['brand_name'])){
   ...
   $brand_query="insert into brand(brand_name) values('$product_brand')";
$brand_run=mysql_query($brand_query);
